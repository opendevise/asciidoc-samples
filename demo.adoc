...
This is a demonstration of {library} {asciidoctor-version}. And this is the preamble of this document.
...
[[1-first-steps-with-asciidoc,First Steps]]
...
.Asciidoctor usage example, should contain 5 lines
[source,ruby]
----
require 'asciidoctor'
